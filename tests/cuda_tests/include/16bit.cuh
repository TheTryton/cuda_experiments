    ...
    color_space colorSpace, bool fullRange, bool preserveRangeOvershoot)
{
    ...
    memcpy<yuv444p16leBlockSize * sizeof(yuv16bit_t)>(destY + offsetY, storeY);
    memcpy<yuv444p16leBlockSize * sizeof(yuv16bit_t)>(destU + offsetU, storeU);
    memcpy<yuv444p16leBlockSize * sizeof(yuv16bit_t)>(destV + offsetV, storeV);
}
    ...
    color_space colorSpace, bool fullRange, bool preserveRangeOvershoot)
{
    ...
    memcpy<yuv422p16leBlockSize * sizeof(yuv16bit_t)>(destY + offsetY, storeY);
    memcpy<yuv422p16leBlockSize / 2 * sizeof(yuv16bit_t)>(destU + offsetU, storeU);
    memcpy<yuv422p16leBlockSize / 2 * sizeof(yuv16bit_t)>(destV + offsetV, storeV);
}
    ...
    color_space colorSpace, bool fullRange, bool preserveRangeOvershoot)
{
    ...
    if(y % 2 == 0)
    {
        ...
        memcpy<yuv420p16leBlockSize * sizeof(yuv16bit_t)>(destY + offsetY, storeY);
        memcpy<yuv420p16leBlockSize / 2 * sizeof(yuv16bit_t)>(destU + offsetU, storeU);
        memcpy<yuv420p16leBlockSize / 2 * sizeof(yuv16bit_t)>(destV + offsetV, storeV);
    }
    else
    {
        alignas(max_align_t) yuv16bit_t storeY[yuv420p16leBlockSize];
